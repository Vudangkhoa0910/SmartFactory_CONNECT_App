...
abstract class AppLocalizations {
  ...
  /// No description provided for @enterIncidentTitle.
  ///
  /// In vi, this message translates to:
  /// **'Nhập tiêu đề sự cố'**
  String get enterIncidentTitle;
  ...
  /// No description provided for @searchByCodeTitleLocation.
  ///
  /// In vi, this message translates to:
  /// **'Tìm theo mã, tiêu đề, vị trí...'**
  String get searchByCodeTitleLocation;
  ...
  /// No description provided for @searchByIdOrTitle.
  ///
  /// In vi, this message translates to:
  /// **'Tìm theo mã hoặc tiêu đề'**
  String get searchByIdOrTitle;
  ...
  /// No description provided for @helpfulArticle.
  ///
  /// In vi, this message translates to:
  /// **'Bài viết hữu ích?'**
  String get helpfulArticle;
  ...
  /// No description provided for @pageDeveloping.
  ///
  /// In vi, this message translates to:
  /// **'Trang đang được phát triển'**
  String get pageDeveloping;
  ...
  /// No description provided for @categoryPersonnel.
  ///
  /// In vi, this message translates to:
  /// **'Nhân sự'**
  String get categoryPersonnel;

  /// No description provided for @issueTypeQuality.
  ///
  /// In vi, this message translates to:
  /// **'Chất lượng'**
  String get issueTypeQuality;

  /// No description provided for @issueTypeSafety.
  ///
  /// In vi, this message translates to:
  /// **'An toàn'**
  String get issueTypeSafety;

  /// No description provided for @issueTypePerformance.
  ///
  /// In vi, this message translates to:
  /// **'Hiệu suất'**
  String get issueTypePerformance;

  /// No description provided for @issueTypeEnergySaving.
  ///
  /// In vi, this message translates to:
  /// **'Tiết kiệm năng lượng'**
  String get issueTypeEnergySaving;

  /// No description provided for @issueTypeProcess.
  ///
  /// In vi, this message translates to:
  /// **'Quy trình'**
  String get issueTypeProcess;

  /// No description provided for @issueTypeWorkEnvironment.
  ///
  /// In vi, this message translates to:
  /// **'Môi trường làm việc'**
  String get issueTypeWorkEnvironment;

  /// No description provided for @issueTypeWelfare.
  ///
  /// In vi, this message translates to:
  /// **'Phúc lợi'**
  String get issueTypeWelfare;

  /// No description provided for @issueTypePressure.
  ///
  /// In vi, this message translates to:
  /// **'Áp lực / Nhân sự'**
  String get issueTypePressure;

  /// No description provided for @issueTypePsychologicalSafety.
  ///
  /// In vi, this message translates to:
  /// **'An toàn tâm lý'**
  String get issueTypePsychologicalSafety;

  /// No description provided for @issueTypeFairness.
  ///
  /// In vi, this message translates to:
  /// **'Công bằng - Công việc'**
  String get issueTypeFairness;
  ...
  /// No description provided for @ideaUnderReview.
  ///
  /// In vi, this message translates to:
  /// **'Đang xem xét'**
  String get ideaUnderReview;

  /// No description provided for @ideaEscalated.
  ///
  /// In vi, this message translates to:
  /// **'Đã chuyển cấp trên'**
  String get ideaEscalated;
  ...
  /// No description provided for @ideaImplementing.
  ///
  /// In vi, this message translates to:
  /// **'Đang triển khai'**
  String get ideaImplementing;

  /// No description provided for @ideaCompleted.
  ///
  /// In vi, this message translates to:
  /// **'Hoàn thành'**
  String get ideaCompleted;
  ...
  /// No description provided for @leaderIncidentReport.
  ///
  /// In vi, this message translates to:
  /// **'Báo cáo sự cố Leader'**
  String get leaderIncidentReport;
  ...
  /// No description provided for @confirmAndAddInfo.
  ///
  /// In vi, this message translates to:
  /// **'Xác nhận & Bổ sung thông tin'**
  String get confirmAndAddInfo;

  /// No description provided for @processingInfo.
  ///
  /// In vi, this message translates to:
  /// **'Thông tin xử lý'**
  ...
  /// No description provided for @enterProductionLine.
  ///
  /// In vi, this message translates to:
  /// **'Nhập tên dây chuyền'**
  String get enterProductionLine;
  ...
  /// No description provided for @enterWorkstation.
  ///
  /// In vi, this message translates to:
  /// **'Nhập công đoạn'**
  String get enterWorkstation;

  /// No description provided for @detectionDepartment.
  ///
  /// In vi, this message translates to:
  /// **'Bộ phận phát hiện'**
  String get detectionDepartment;

  /// No description provided for @enterDetectionDepartment.
  ///
  /// In vi, this message translates to:
  /// **'Nhập bộ phận phát hiện'**
  String get enterDetectionDepartment;

  /// No description provided for @leaderNotes.
  ///
  /// In vi, this message translates to:
  /// **'Ghi chú của Leader'**
  String get leaderNotes;

  /// No description provided for @enterLeaderNotes.
  ///
  /// In vi, this message translates to:
  /// **'Nhập ghi chú của Leader...'**
  String get enterLeaderNotes;

  /// No description provided for @enterLeaderNotesOptional.
  ///
  /// In vi, this message translates to:
  /// **'Nhập ghi chú (tùy chọn)'**
  String get enterLeaderNotesOptional;

  /// No description provided for @confirmPriority.
  ///
  /// In vi, this message translates to:
  /// **'Xác nhận mức độ ưu tiên'**
  String get confirmPriority;
  ...
  /// No description provided for @enterLocationDevice.
  ///
  /// In vi, this message translates to:
  /// **'Nhập vị trí hoặc tên thiết bị'**
  String get enterLocationDevice;

  /// No description provided for @pleaseEnterLocation.
  ///
  /// In vi, this message translates to:
  /// **'Vui lòng nhập vị trí hoặc thiết bị'**
  ...
  /// No description provided for @selectedVideos.
  ///
  /// In vi, this message translates to:
  /// **'Video đã chọn'**
  String get selectedVideos;
  ...
  /// No description provided for @listeningRelease.
  ///
  /// In vi, this message translates to:
  /// **'Đang nghe... Thả ra để dừng'**
  String get listeningRelease;
  ...
  /// No description provided for @approvedAndSentToAdmin.
  ///
  /// In vi, this message translates to:
  /// **'Đã duyệt và gửi báo cáo lên Admin'**
  String get approvedAndSentToAdmin;

  /// No description provided for @cannotApproveReport.
  ///
  /// In vi, this message translates to:
  /// **'Không thể duyệt báo cáo'**
  String get cannotApproveReport;

  /// No description provided for @returnToUser.
  ///
  /// In vi, this message translates to:
  /// **'TRẢ LẠI USER'**
  String get returnToUser;
  ...
  ///
  /// In vi, this message translates to:
  /// **'Lý do trả lại (VD: Cần chụp ảnh rõ hơn)'**
  String get returnReasonHint;

  /// No description provided for @pleaseEnterReturnReason.
  ///
  /// In vi, this message translates to:
  /// **'Vui lòng nhập lý do trả lại'**
  String get pleaseEnterReturnReason;

  /// No description provided for @returnedToUser.
  ///
  /// In vi, this message translates to:
  /// **'Đã trả lại báo cáo cho User'**
  String get returnedToUser;

  /// No description provided for @cannotReturnReport.
  ///
  /// In vi, this message translates to:
  ...
  /// No description provided for @cancelledByLeader.
  ///
  /// In vi, this message translates to:
  /// **'Đã hủy bởi Leader'**
  String get cancelledByLeader;
  ...
  /// No description provided for @cannotCancelReport.
  ///
  /// In vi, this message translates to:
  /// **'Không thể hủy báo cáo'**
  String get cannotCancelReport;
  ...
  /// No description provided for @processingBy.
  ///
  /// In vi, this message translates to:
  /// **'Đang xử lý bởi'**
  String get processingBy;
  ...
  /// No description provided for @confirmAdditionalInfo.
  ///
  /// In vi, this message translates to:
  /// **'Xác nhận & Bổ sung thông tin'**
  String get confirmAdditionalInfo;

  /// No description provided for @issueClassification.
  ///
  /// In vi, this message translates to:
  /// **'Phân loại vấn đề'**
  String get issueClassification;

  /// No description provided for @workstationLabel.
  ///
  /// In vi, this message translates to:
  /// **'Công đoạn'**
  String get workstationLabel;

  /// No description provided for @detectionDepartmentLabel.
  ///
  /// In vi, this message translates to:
  /// **'Bộ phận phát hiện'**
  String get detectionDepartmentLabel;
  ...
  /// No description provided for @statusInProcessing.
  ///
  /// In vi, this message translates to:
  /// **'Đang xử lý'**
  String get statusInProcessing;
  ...
  /// No description provided for @statusClosedLabel.
  ///
  /// In vi, this message translates to:
  /// **'Đã đóng'**
